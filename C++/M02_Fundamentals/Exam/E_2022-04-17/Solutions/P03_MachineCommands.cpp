...
void subtract(std::vector<int>& numbers) {
...
void concat(std::vector<int>& numbers) {
	...
	int num1 = numbers.end()[-2];
	int num2 = numbers.back();

	numbers.pop_back();
	numbers.pop_back();

	std::string numToStr1 = std::to_string(num1);
	std::string numToStr2 = std::to_string(num2);

	std::string result = numToStr1 + numToStr2;
	int num = stoi(result);
