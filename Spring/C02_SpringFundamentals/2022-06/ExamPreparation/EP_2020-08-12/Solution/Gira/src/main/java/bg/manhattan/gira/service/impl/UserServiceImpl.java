...
import bg.manhattan.gira.repository.UserRepository;
import bg.manhattan.gira.security.CurrentUser;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean loginUser(UserServiceLoginModel userModel) {
        Optional<User> dbUser = this.userRepository.findByEmail(userModel.getEmail());
        if (dbUser.isEmpty()) {
            return false;
        }
