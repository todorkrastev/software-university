...
public class WizardDeposits extends BaseEntity {
    ...
    private boolean is_depositExpired;
    ...
    @Column(name = "eposit_expiration_date")
    ...
    public boolean isIs_depositExpired() {
        return is_depositExpired;
    }

    public void setIs_depositExpired(boolean is_depositExpired) {
        this.is_depositExpired = is_depositExpired;
    }
}
