CREATE TABLE towns( id INT(11) PRIMARY KEY AUTO_INCREMENT, name VARCHAR(20) NOT NULL , country VARCHAR(20) );
CREATE TABLE villains( id INT(11) PRIMARY KEY AUTO_INCREMENT, name VARCHAR(20) NOT NULL, evilness_factor ENUM('good', 'bad', 'evil', 'super evil'));
CREATE TABLE minions(  id INT(11) PRIMARY KEY AUTO_INCREMENT,name VARCHAR(20) NOT NULL,age INT(11) NOT NULL ,town_id INT(11),CONSTRAINT fk_minions_towns FOREIGN KEY (town_id) REFERENCES towns(id));
CREATE TABLE minions_villains( minion_id INT(11),villain_id INT(11),CONSTRAINT fk_minions_villains FOREIGN KEY (minion_id) REFERENCES minions(id),CONSTRAINT fk_villains_minions FOREIGN KEY (villain_id) REFERENCES villains(id));
