...
public class ModelMapperConfig {
    ...
    private void productProductsInRangeDto(ModelMapper mapper) {
        ...
        mapper.createTypeMap(Product.class, ProductInRangeDto.class)
                .addMappings(mpr -> {
                    mpr.using(priceToString).map(Product::getPrice, ProductInRangeDto::setPrice);
                    mpr.using(toFullName).map(Product::getSeller, ProductInRangeDto::setSeller);
                });
    }
