...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public <T> T[] readJSONFile(String filePath, Class<?> clazz) throws IOException {
    ...
    @Override
    public <T> T readXMLFile(String filePath, Class<?> clazz) throws IOException, JAXBException {
