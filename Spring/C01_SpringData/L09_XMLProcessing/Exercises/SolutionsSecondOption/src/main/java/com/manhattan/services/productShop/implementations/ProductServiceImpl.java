...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public ProductsInRangeRootDto getNotBoughtProductsWithPriceInRange(BigDecimal min, BigDecimal max) {
        return new ProductsInRangeRootDto(List.of(
                mapper.map(
                        this.repository.findByBuyerIsNullAndPriceBetweenOrderByPriceAsc(min, max),
